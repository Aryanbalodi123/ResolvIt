  ...
  const steps = [
    {
      ...
      desc: "Users register complaints with issue details, category, and optional attachments.",
    },
    {
      Icon: RouteIcon,
      title: "Smart Routing",
      desc: "The system automatically forwards complaints to the correct department or authority.",
    },
    {
      Icon: LiveIcon,
      title: "Live Tracking",
      desc: "Users can monitor complaint progress in real time through status updates.",
    },
    {
      Icon: AdminIcon,
      title: "Admin Action",
      desc: "Administrators review, prioritize, and resolve complaints efficiently.",
    },
    {
      Icon: FeedbackIcon,
      title: "Resolution & Feedback",
      desc: "Users receive resolution updates and can share feedback on their experience.",
    },
  ];
    ...
    <div className="landing-root">
      ...
      >
        <div className="landing-nav__inner">
          ...
          <div className="landing-nav__actions" id="navbar-actions">
            ...
            <button className="btn btn--primary" id="btn-free-trial" onClick={() => navigate("/login")}>
              Login
            </button>
          </div>
        ...
        <div className="hero__container">
          <div className="hero__text">
            ...
            <div className="hero__ctas" id="hero-ctas">
              <button className="btn btn--primary btn--lg" id="btn-get-started" onClick={() => navigate("/register")}>
                Get Started
              </button>
            ...
            <div className="hero__proof" id="hero-proof">
              <div className="hero__avatars">
                {[1, 2, 3, 4].map((i) => (
                  <span key={i} className="hero__avatar" style={{ "--i": i }}>
                    {String.fromCharCode(64 + i)}
                  </span>
                ))}
              </div>
              <p className="hero__proof-text">
                <strong>2,400+</strong> complaints resolved successfully
              </p>
            </div>
          </div>
      ...
      <section className="hiw" id="how-it-works">
        <div className="hiw__header">
          <span className="services__eyebrow">Step by Step</span>
          <h2 className="hiw__title">
            How <span className="hero__highlight">ComplaintUs</span> Works
          </h2>
          <p className="hiw__subtitle">
            A seamless complaint management workflow designed for speed,
        ...
        <div className="hiw__flow">
          {steps.map((step, idx) => (
            <div className="hiw__item" key={step.title}>
              <div className="hiw__card" id={`hiw-step-${idx}`} style={{ "--delay": `${idx * 0.12}s` }}>
                <span className="hiw__step-num">0{idx + 1}</span>
