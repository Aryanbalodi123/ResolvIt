    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-gray-800 font-['Inter']">Dashboard</h1>
            <p className="text-gray-600 mt-1 font-['Inter']">Welcome back, John! Manage your complaints and stay updated on their progress.</p>
          </div>
        ...
        {stats.map((stat, index) => {
          ...
          return (
            <div key={index} className="bg-white/40 backdrop-blur-sm rounded-xl border border-white/40 p-6 hover:shadow-lg transition-all duration-200 card-hover">
              ...
              <div className="mt-4">
                <h3 className="font-medium text-gray-800 font-['Inter']">{stat.title}</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white/40 backdrop-blur-sm rounded-xl border border-white/40">
          <div className="p-6 border-b border-white/30">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-800 font-['Inter']">Recent Complaints</h2>
        ...
        <div className="space-y-6">
              ...
              <button className="w-full p-4 bg-gradient-to-r from-pink-300 to-rose-300 text-white rounded-xl hover:from-pink-400 hover:to-rose-400 transition-all duration-200 text-left shadow-md">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/80 font-['Inter']">Report a new issue</div>
                  </div>
                </div>
              </button>
              ...
              <button className="w-full p-4 bg-gradient-to-r from-purple-300 to-indigo-300 text-white rounded-xl hover:from-purple-400 hover:to-indigo-400 transition-all duration-200 text-left shadow-md">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/80 font-['Inter']">Add to lost & found</div>
                  </div>
                </div>
              </button>
              ...
              <button className="w-full p-4 bg-white/30 border border-white/40 text-gray-700 rounded-xl hover:bg-white/40 transition-colors text-left backdrop-blur-sm">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-600 font-['Inter']">Share your thoughts</div>
                  </div>
                </div>
              </button>
            </div>
          ...
          <div className="bg-white/40 backdrop-blur-sm rounded-xl border border-white/40">
            <div className="p-6 border-b border-white/30">
              <h2 className="text-lg font-semibold text-gray-800 font-['Inter']">This Month</h2>
            </div>
            <div className="p-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600 font-['Inter']">Complaints submitted</span>
                  <span className="text-sm font-medium text-gray-800 font-['Inter']">3</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600 font-['Inter']">Issues resolved</span>
                  <span className="text-sm font-medium text-gray-800 font-['Inter']">1</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600 font-['Inter']">Average response time</span>
                  <span className="text-sm font-medium text-gray-800 font-['Inter']">2 days</span>
                </div>
              </div>
